...
#define NET_MAGIC_ID 51296165
#define NET_PROTOCOL_ID 9001//just an integer, so can be pmuch any value
#define PACKET_MTU 1400//not used
#define NET_PING_INTERVAL 500//how often a packet is sent automatically if no packet is sent manually
...
enum NetCommandPackets
{
	NetConnectionRequest = 97,
	NetPing = 98,
	NetDisconnect = 99
};
